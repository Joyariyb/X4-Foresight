  ...
  const WIRE_SVG_BY_SIZE = {
    ...
    <g fill="none" stroke="var(--color-primary)" stroke-width="1.1"><polygon points="70,5 80,26 76,54 70,60 64,54 60,26"/><line x1="70" y1="5" x2="70" y2="60"/><polygon points="60,30 41,38 44,49 60,45"/><polygon points="80,30 99,38 96,49 80,45"/></g>
    <g fill="none" stroke="var(--color-alert)" stroke-width="1.1"><line x1="66" y1="56" x2="66" y2="63"/><line x1="74" y1="56" x2="74" y2="63"/></g></svg>`,

    M: `<svg viewBox="0 0 170 115" style="filter:drop-shadow(0 0 4px rgba(88,166,255,0.55))" aria-hidden="true">
    <g fill="none" stroke="var(--color-primary)" stroke-width="1.1">
    ...
    <g fill="none" stroke="var(--color-alert)" stroke-width="1.1">
      <line x1="81" y1="97" x2="81" y2="105"/>
      <line x1="89" y1="97" x2="89" y2="105"/>
    </g>
    <g stroke="var(--color-warning)" stroke-width="1.1">
      <circle cx="66" cy="80" r="2.6" fill="var(--color-warning)"/><line x1="66" y1="80" x2="57" y2="80"/>
      <circle cx="104" cy="80" r="2.6" fill="var(--color-warning)"/><line x1="104" y1="80" x2="113" y2="80"/>
    </g></svg>`,
    ...
    <g fill="none" stroke="var(--color-primary)" stroke-width="1.6">
    ...
    <g stroke="var(--color-warning)" stroke-width="1.1">
      <circle cx="79" cy="28" r="1.8" fill="var(--color-warning)"/><line x1="79" y1="28" x2="89" y2="28"/>
      <circle cx="79" cy="55" r="1.8" fill="var(--color-warning)"/><line x1="79" y1="55" x2="91" y2="55"/>
      <circle cx="130" cy="90" r="1.8" fill="var(--color-warning)"/><line x1="130" y1="90" x2="130" y2="80"/>
      <circle cx="28" cy="90" r="1.8" fill="var(--color-warning)"/><line x1="28" y1="90" x2="28" y2="80"/>
    </g>
    <g fill="none" stroke="var(--color-special)" stroke-width="1.1">
    ...
    <g fill="none" stroke="var(--color-negative)" stroke-width="1.2">
      <rect x="98" y="18" width="14" height="14"/>
      <line x1="102" y1="18" x2="102" y2="0"/>
      <line x1="108" y1="18" x2="108" y2="0"/>
      <line x1="100" y1="0" x2="110" y2="0"/>
    </g>
    <g fill="none" stroke="var(--color-negative)" stroke-width="1.3">
      <circle cx="105" cy="75" r="8"/>
      <circle cx="105" cy="115" r="8"/>
      <circle cx="105" cy="155" r="8"/>
    </g>
    <g stroke="var(--color-warning)" stroke-width="1.1">
      <circle cx="135" cy="45" r="1.8" fill="var(--color-warning)"/><line x1="135" y1="45" x2="143" y2="40"/>
      <circle cx="75" cy="45" r="1.8" fill="var(--color-warning)"/><line x1="75" y1="45" x2="67" y2="40"/>
    </g>
    <g fill="none" stroke="var(--color-special)" stroke-width="1.1">
