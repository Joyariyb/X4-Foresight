# Core role: Auto-generated station module + shield equipment catalog (macro → {max_hull, max_shield, cargo_capacity, produces, name}).
...
STATION_STATS = {
    ...
    'shield_gen_m_corvette_01_mk1_macro': {
        'max_shield':     8600,
        'name':           'Shield Generator',
    },
